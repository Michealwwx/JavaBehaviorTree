 ...
 * </pre>
 * 
 * Where <i>configurationFile</i> is an . file that contains all the
		...
		try {
			...
			for (Element currentBTLibrary : btLibrariesDescription) {
				try {
					...
					jbt_generator.librarygenerator.BTLibraryGenerator generator = new jbt_generator.librarygenerator.BTLibraryGenerator();
