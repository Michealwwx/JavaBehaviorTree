...
import jbt_generator.lowlevelgenerator.ActionsGenerator;
import jbt_generator.lowlevelgenerator.ConditionsGenerator;
import jbt_generator.util.Util;
...
public class ActionsAndConditionsGenerator {
	/** Tag of the XML configuration file. ActionsAndConditionsGenerator  -c configurationFile -r Configuration.xml*/
