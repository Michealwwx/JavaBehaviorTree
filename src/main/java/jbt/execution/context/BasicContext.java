...
public class BasicContext implements IContext {
	...
	/**
	 * 
	 * @see es.ucm.bt.core.IContext#getVariable(String)
	 */
	...
	/**
	 * 
	 * @see es.ucm.bt.core.IContext#setVariable(String,
	 *      Object)
	 */
	...
	/**
	 * 
	 * @see IContext#clearVariable(String)
	 */
