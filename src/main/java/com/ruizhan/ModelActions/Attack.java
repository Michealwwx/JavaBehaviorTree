...
//                       DO NOT MODIFY                     
//                                                         
// Generated on 11/28/2018 18:11:10
// ******************************************************* 
...
public class Attack extends jbt.model.task.leaf.action.ModelAction {
	...
	/**
	 * Returns a com.ruizhan.ExecutionActions.Attack task that is able to run
	 * this task.
	 */
	public jbt.execution.core.ExecutionTask createExecutor(
			jbt.execution.core.BTExecutor executor,
			jbt.execution.core.ExecutionTask parent) {
		return new com.ruizhan.ExecutionActions.Attack(this, executor, parent,
